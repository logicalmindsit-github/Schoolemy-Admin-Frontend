...
const dataMaintenanceTools = [
  {
    ...
    icon: "💰",
    path: "/schoolemy/direct-meet-fees",
  ...
  },
  {
    ...
    icon: "📜",
    path: "/schoolemy/participant-certificates",
  ...
  },
  {
    ...
    icon: "🔬",
    path: "/schoolemy/practice-class-list",
